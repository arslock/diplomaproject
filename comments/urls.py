from .views import ClassWorkCommentViewSet, QuizCommentViewSet, MaterialCommentViewSet, LessonCommentViewSet, ClassMaterialComments, ClassLessonComments, ClassQuizComments, ClassWorkCommentsList
...
urlpatterns = [
path('classwork-class/<int:classwork_id>/', ClassWorkCommentsList.as_view(), name='class-homework-comment-list'),
